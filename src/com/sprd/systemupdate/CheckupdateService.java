        ...
        public Integer doInBackground(Void... v) {
            ...
            try {
                ...
                if (deal_result == CHECK_UPDATE_HAS_UPDATE) {
                    ...
                    if (!newVersion.equals(olderVersion) && mCurrentDownload == null && mStorage.getState() == Storage.State.NIL) {
                        mStorage.setLatestVersion(json);
                        mStorage.setSize(0);
                    }
                    /*bug947949 systemupdate-download or pause issue*/
                    if (!newVersion.equals(olderVersion) && mCurrentDownload != group) {
                        mStorage.setLatestVersion(json);
                    }
                }
                return deal_result;
                ...
                Log.e(TAG, "CheckUpdateTask--IllegalArgumentException:" + e);
                return CHECK_UPDATE_CONNECT_ERROR;
            }  finally {
                try {
                    if (reader != null) {
                    ...
                    Log.e(TAG, "CheckUpdateTask--IOException:" + e);
                }
            }
