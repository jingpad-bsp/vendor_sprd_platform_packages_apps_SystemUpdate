...
public class TimerBroadcastReceiver extends BroadcastReceiver {
    ...
    private IntentFilter pushReceiverIntent;
    ...
    public void onReceive(Context context, Intent intent) {
                        ...
                        .setPositiveButton(R.string.ok,
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog,
                                        ...
                                        mIntentDownloadSucceed.putExtra("storageState", mStorage.getState());
        ...
        pushReceiverIntent = new IntentFilter();
        pushReceiverIntent.addAction(ConnectivityManager.CONNECTIVITY_ACTION);
        pushReceiver = new PushReceiver();
        mContext.getApplicationContext().registerReceiver(pushReceiver, pushReceiverIntent);
    }

    public void finish(){
        if(pushReceiver != null) {
            mContext.getApplicationContext().unregisterReceiver(pushReceiver);
        }
    }
}
