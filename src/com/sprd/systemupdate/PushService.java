...
public class PushService extends Service {
    public static final String SERVER_ADDR = "116.228.149.54";
                ...
                public void processPacket(Packet pkt) {
                    ...
                    if (info != null) {
                        ...
                        if (android.os.Build.VERSION.SDK_INT >= 26) {
                            ...
                            NotificationChannel mSystemUpdateChannel = new NotificationChannel(id, "systemUpdate", NotificationManager.IMPORTANCE_LOW);
                            nm.createNotificationChannel(mSystemUpdateChannel);
    ...
    private int registerIfNeeded() {
        ...
        try {
            ...
            String series = mTokenVerification.mSeries;
            ...
            pairs.add(new BasicNameValuePair("series", series));
    ...
    public PendingIntent sameVersionPushProcess() {
        ...
        } else if (mStorage.getState() == Storage.State.DOWNLOADED || mStorage.getState() == Storage.State.DOWNLOADED_SPECIAL || mStorage.getState() == Storage.State.DOWNLOADED_DAILY) {
